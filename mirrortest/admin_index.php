...
<body style="font-family:'Alegreya SC';">
	...
	<nav class="nav navbar-default" id="myDIV">
      <div class="container-fluid">
        <div class="navbar-header">
          <a href="admin_index.php" class="navbar-brand" id="athomepage" style="font-size:18px;">Update Promotion</a>
	...
	<div class="container-fluid" style="margin-top:10px;">
		...
		<div class="rows">
			<div class="col-md-6">
				<h1 style="text-align:center;"><span style="font-size:40px;">Update Promotion</span></h1>
				<table >
					<form method="post" action="admin_index.php" enctype="multipart/form-data">
						<input type="hidden" name="size" value="100000000" />

						Description : <textarea type="text" name="description" rows="5" cols="50"></textarea><input type="file" name="image" />
						<br/>
						<input type="submit" name="upload" value="Upload Image" style="width:150px;"/>
					</form>
				</table>
			</div>
			<div class="col-md-6">
				...
				?>
				<br/>
				<h3> Preview uploaded photo</h3>
				<?php
				echo "<img src='img/".$rows['image']."' width=300px; ><br/><br/>";
				echo '<h3>'.$rows['text'].'</h3>';
				 ?>
			</div>
		</div>
	</div>
